...
void cursorTo(unsigned char, unsigned char);
void printString( char *);
void drawImage( const unsigned char * , unsigned char , unsigned char , unsigned char , unsigned char  );
void drawImage2( const unsigned char * , unsigned char , unsigned char , unsigned char , unsigned char  );
void clear(void);
